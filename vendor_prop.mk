PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    ro.config.music_headset_volume=5 \
    ...
    ro.keybox.id.value=meizuC9 \
    ro.launcher.shakewallpaper=false \
    ro.launcher_mainmenu_transparent=1 \
    ro.lmk.vmpressurenhanced=true \
    ro.meizu.carrier.model=M819H \
    ro.meizu.product.model=M819H \
    ro.miki_accelerate_diapad_anim=1 \
    ro.miki_add_breathing_light=1 \
    ro.miki_add_lockscreen_shar=1 \
    ro.miki_add_meizu_carrier_name=1 \
    ro.miki_add_timeout_never=1 \
    ro.miki_automatic_shut_down=1 \
    ro.miki_bat_temp_low_shutdown=1 \
    ro.miki_disable_multiwindow=1 \
    ro.miki_failure_vibration_led=1 \
    ro.miki_fonts_myanmar=1 \
    ro.miki_keep_refresh_blue=1 \
    ro.miki_label_edit_length=1 \
    ro.miki_qspanel_detail_ghost=1 \
    ro.miki_refresh_directory=1 \
    ro.miki_remove_bat_charge_led=1 \
    ro.miki_remove_local_update=1 \
    ro.miki_set_recents_transparent=1 \
    ro.miki_show_high_temp_warning=1 \
    ro.miki_show_input_click_note=1 \
    ro.miki_ui_exit_setupwizard=1 \
